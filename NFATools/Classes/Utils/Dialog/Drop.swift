...
public enum DropState: DropStatable {
    ...
    public var backgroundColor: UIColor? {
        switch self {
        case .info: return UIColor(red: 44.0/255, green: 187.0/255, blue: 255.0/255, alpha: 0.90) // return UIColor(red: 52/255.0, green: 152/255.0, blue: 219/255.0, alpha: 0.9)
        case .success: return UIColor(red: 142.0/255, green: 183.0/255, blue: 64.0/255, alpha: 0.95)//return UIColor(red: 39/255.0, green: 174/255.0, blue: 96/255.0, alpha: 0.9)
        case .warning: return UIColor(red: 230.0/255, green: 189.0/255, blue: 1.0/255, alpha: 0.95)//return UIColor(red: 241/255.0, green: 196/255.0, blue: 15/255.0, alpha: 0.9)
        case .error: return UIColor(red: 219.0/255, green: 36.0/255, blue: 27.0/255, alpha: 0.70)// return UIColor(red: 192/255.0, green: 57/255.0, blue: 43/255.0, alpha: 0.9)
...
extension Drop {
    ...
    class func show(_ status: String, state: DropStatable, duration: Double, action: DropAction?) {
        self.upAll()
        ...
        UIView.animate(withDuration: TimeInterval(0.25), delay: TimeInterval(0.0), options: [.allowUserInteraction, .curveEaseOut], animations: {
            superview.layoutIfNeeded()
        }, completion: nil)
    }
    ...
    fileprivate class func up(_ drop: Drop, interval: TimeInterval) {
        ...
        UIView.animate(withDuration: interval, delay: TimeInterval(0.0), options: [.allowUserInteraction, .curveEaseIn], animations: {
            superview.layoutIfNeeded()
